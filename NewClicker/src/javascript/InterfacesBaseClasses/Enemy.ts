...
class Unit implements IMortality, ICombative, IFeedbackLoop, IExistence, IRegeneration {
...
class Enemy implements IMortality, ICombative, IFeedbackLoop, IRegeneration {
